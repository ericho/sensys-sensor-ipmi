...
void ut_persist_sel_record_id::test_reset()
{
    ...
    mocks[SET_LAN_OPTIONS].pushState(LEGACY);
...
TEST_F(ut_persist_sel_record_id, old_hand_editted_file)
{
    ...
    ipmi_ts_persist_sel_record_id* obj = new ipmi_ts_persist_sel_record_id("test_aggregator", test_error_sink_c);
...
TEST_F(ut_persist_sel_record_id, bad_value_correction)
{
    test_reset();
    test_save_file(test_filename, messy_file);
    ipmi_ts_persist_sel_record_id* obj = new ipmi_ts_persist_sel_record_id("test_node11", test_error_sink_c);
    obj->load_last_record_id(test_filename.c_str());
    int id = obj->get_record_id();
    ASSERT_EQ(id, 3);
...
TEST_F(ut_persist_sel_record_id, illegal_value_default)
{
    test_reset();
    test_save_file(test_filename, messy_file);
    ipmi_ts_persist_sel_record_id* obj = new ipmi_ts_persist_sel_record_id("test_node08", test_error_sink_c);
    obj->load_last_record_id(test_filename.c_str());
    int id = obj->get_record_id();
    ASSERT_EQ(id, 3);
...
TEST_F(ut_persist_sel_record_id, new_entry_added_to_file)
{
    test_reset();
    test_save_file(test_filename, messy_file);
    ipmi_ts_persist_sel_record_id* obj = new ipmi_ts_persist_sel_record_id("test_node15", test_error_sink_c);
    obj->load_last_record_id(test_filename.c_str());
    int id = obj->get_record_id();
    ASSERT_EQ(id, 0);
